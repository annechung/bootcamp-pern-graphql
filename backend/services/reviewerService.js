 ...
 */
 ...
 async function createReviewer(name, email) {
...
//  async function updateReviewer(id, name, email) {
...
//  }
 ...
 const reviewerService = { getReviewer, getReviewers, createReviewer, deleteReviewer };
